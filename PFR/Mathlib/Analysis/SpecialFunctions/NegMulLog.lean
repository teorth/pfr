...
lemma sum_mul_log_div_leq {a b: s → ℝ} (ha: ∀ i, 0 ≤ a i) (hb: ∀ i, 0 ≤ b i) : ∑ i, (a i) * log (a i / b i) ≤ (∑ i, a i) * log ((∑ i, a i) / (∑ i, b i)) := sorry
...
lemma sum_mul_log_div_eq_iff {a b: s → ℝ} (ha: ∀ i, 0 ≤ a i) (hb: ∀ i, 0 ≤ b i) (heq: ∑ i, (a i) * log (a i / b i) = (∑ i, a i) * log ((∑ i, a i) / (∑ i, b i))) : ∃ r:ℝ, ∀ i, a i = r * (b i) := sorry
