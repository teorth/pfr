...
\begin{proof}\uses{key, data-process}
  ...
  Since $Z_1$ is a function of $(P_i)_{i \in \Z/m\Z}$ by~\eqref{pqr-defs}, and similarly $Z_2$ is a function of $(Q_j)_{j \in \Z/m\Z}$, it follows immediately from Lemma \ref{data-process} that
  \[
    \bbI[ Z_1 : Z_2 \,|\, W ] \leq t.
  \]
 ...
 Similarly, the column sums for $j \in \{1,\dots, m\}$ are
  ...
  Hence, using~\eqref{pqr-defs} and Lemma \ref{data-process} again, Proposition \ref{key} tells us
  \[
