...
\begin{proof}\uses{relabeled-entropy, chain-rule}
We have
...
\begin{proof}\uses{mutidist-lower, cond-multidist-def, cond-multidist-alt}
...
\begin{proof}\uses{lem:get-better, multidist-ruzsa-III, multidist-lower, xi-z2-w-dist, eta-def-multi, multidist-nonneg} For each value $W=w$, apply Lemma \ref{lem:get-better} to
  \[
    T_1 = (Z_1 \,|\, W \mathop{=} w),\
    T_2 = (Z_2 \,|\, W \mathop{=} w),\
    T_3 = (Z_3 \,|\, W \mathop{=} w)
