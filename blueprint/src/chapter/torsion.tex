...
\begin{proof}\uses{lem:get-better, multidist-ruzsa-III, multidist-lower, xi-z2-w-dist, eta-def-multi, multidist-nonneg, Zero-sum} For each value $W=w$, apply Lemma \ref{lem:get-better} (and Lemma \ref{Zero-sum}) to
  \[
    T_1 = (Z_1 \,|\, W \mathop{=} w),\
    T_2 = (Z_2 \,|\, W \mathop{=} w),\
    T_3 = (Z_3 \,|\, W \mathop{=} w)
