...
\begin{proof}\uses{klm-1, neg-ent, ruz-indep, sumset-lower, ruz-copy, multidist-copy}\leanok
...
\begin{proof}\uses{independent-exist, kv, sumset-lower, ruz-indep}\leanok
