...
\begin{lemma}\label{torsion-free-doubling}
...
\begin{lemma}\label{torsion-dist-shrinking}
...
\begin{lemma}\label{pfr-projection}
...
\begin{lemma}\label{single-fibres}
...
\begin{definition}\label{dimension-def}
...
\begin{theorem}\label{weak-pfr-asymm}
...
\begin{theorem}\label{weak-pfr-symm}
...
\begin{theorem}\label{weak-pfr-int}
