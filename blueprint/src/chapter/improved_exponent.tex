...
\begin{lemma}[Constructing good variables, I']\label{construct-good-prelim'}\lean{construct_good_prelim'}
  One has
  \begin{align*}  k \leq
...
\begin{lemma}[Constructing good variables, III']\label{averaged-construct-good}\lean{averaged_construct_good}
  One has
...
\begin{lemma}[Bound on distance differences]\label{dist-diff-bound}\label{dist_diff_bound} We have
...
\begin{theorem}[Improved entropy version of PFR]\label{entropy-pfr'}\lean{entropic_PFR_conjecture'}\leanok
...
\begin{theorem}[Improved PFR]\label{pfr'}\lean{PFR_conjecture'}\leanok
