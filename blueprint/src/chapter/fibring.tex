...
\begin{proof}
\uses{fibring-ident, ruzsa-nonneg, independent-exist, ruz-copy, conditional-mutual-nonneg}
By Lemma \ref{independent-exist}, Lemma \ref{ruz-copy} we may assume $X,Y$ to be independent.
By Proposition \ref{fibring-ident} and Lemma \ref{conditional-mutual-nonneg} we have
