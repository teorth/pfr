...
\begin{proof}\uses{cond-reduce, alternative-mutual, relabeled-entropy-cond, neg-ent} \leanok
    By Lemma \ref{cond-reduce}, \ref{relabeled-entropy-cond}, \ref{alternative-mutual}, \ref{neg-ent} we have
$$
