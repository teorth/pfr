...
\begin{proof}\uses{alt-submodularity,subadditive, relabeled-entropy, add-entropy, ruz-indep} By Lemma \ref{ruz-copy} and Lemmas \ref{independent-exist}, \ref{ruz-indep}, it suffices to show that
