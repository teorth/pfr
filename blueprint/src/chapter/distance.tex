...
\begin{proof} \uses{neg-ent}\leanok Immediate from \Cref{neg-ent} and Definition \ref{ruz-dist-def}.
\end{proof}
...
\begin{proof} \uses{sumset-lower, neg-ent} \leanok Immediate from \Cref{sumset-lower} and Definition \ref{ruz-dist-def}, and also \Cref{neg-ent}.
\end{proof}
...
\begin{proof}\uses{ruz-copy, ruz-indep, independent-exist, ruzsa-triangle-improved}\leanok By \Cref{ruz-copy} and Lemmas \ref{independent-exist}, \ref{ruz-indep}, it suffices to prove this inequality assuming that $X,Y,Z$ are defined on the same space and are independent.  But then the claim follows from \Cref{ruzsa-triangle-improved} and Definition \ref{ruz-dist-def}.
\end{proof}
...
\begin{proof}\uses{copy-ent, ruz-copy, ruz-indep, cond-dist-def, conditional-entropy-def}\leanok Straightforward thanks to \Cref{copy-ent}, \Cref{ruz-copy}, \Cref{ruz-indep}, Definition \ref{cond-dist-def}, Definition \ref{conditional-entropy-def}.
\end{proof}
...
\end{align*}
Here, in the middle step we used \Cref{cond-reduce}, and in the last step we used Definition \ref{ruz-dist-def} and Definition \ref{information-def}.
\end{proof}
...
\begin{lemma}[Comparison of Ruzsa distances, I]\label{first-useful}
  ...
  Turning to~\eqref{ruzsa-3}, we have from Definition \ref{information-def} and \Cref{relabeled-entropy}
