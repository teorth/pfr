...
\begin{definition}[Copy]\label{copy-def}
  \lean{ProbabilityTheory.isCopy}\leanok
...
\begin{lemma}[Copy preserves entropy]\label{copy-ent}
  ...
  \lean{ProbabilityTheory.entropy_of_copy}\leanok
...
\lean{cond_rdist_of_copy, cond_rdist'_of_copy, cond_rdist_of_indep, cond_rdist'_of_indep}
