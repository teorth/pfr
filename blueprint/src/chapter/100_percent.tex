...
\begin{proof}\uses{zero-large,sym-group-def}\leanok  The law of $X-x_0$ is invariant under $\mathrm{Sym}[X]$, non-zero at the origin, and supported on  $\mathrm{Sym}[X]$, giving the claim.
\end{proof}
