...
\begin{lemma}[Uniform distributions exist]\label{unif-exist}
  \uses{uniform-def}
  \lean{ProbabilityTheory.exists_uniform}\leanok
...
\begin{proof} \uses{conditional-nonneg}\leanok Immediate from Lemma \ref{conditional-nonneg} and Definitions \ref{conditional-mutual-def}, \ref{conditional-independent-def}.
\end{proof}
...
\begin{proof} \uses{vanish-entropy, conditional-mutual-alt}\leanok Immediate from Lemma \ref{vanish-entropy} and Lemma \ref{conditional-mutual-alt}.
\end{proof}
