...
\begin{lemma}[Conditional entropy and relabeling]\label{relabeled-entropy-cond}
  ...
  \lean{ProbabilityTheory.condEntropy_of_inj_map, ProbabilityTheory.condEntropy_of_inj_map'}\leanok
...
\begin{lemma}[Conditional chain rule]\label{conditional-chain-rule}
  \lean{ProbabilityTheory.cond_chain_rule}\leanok
...
\begin{proof} \uses{vanish-entropy, conditional-mutual-alt} Immediate from Lemma \ref{vanish-entropy} and Lemma \ref{conditional-mutual-alt}.
\end{proof}
