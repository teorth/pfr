...
\begin{lemma}[Entropy and relabeling]\label{relabeled-entropy}\lean{ProbabilityTheory.entropy_of_inj_map} \uses{entropy-def}
...
\begin{proof}
  ...
  Set up an injection from $\langle X,Y\rangle$ to $\langle Y,X\rangle$ and use Lemma \ref{relabeled-entropy}.
\end{proof}
...
\begin{lemma}[Alternative formulae for mutual information]
  ...
  \lean{ProbabilityTheory.mutualInformation_comm} % and below
  \leanok
