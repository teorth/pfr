...
\begin{proof}\uses{first-fibre, first-dist-sum, first-cond, first-upper}\leanok  Take a suitable linear combination of Lemma \ref{first-fibre}, Lemma \ref{first-dist-sum}, Lemma \ref{first-cond}, and Lemma \ref{first-upper}.
\end{proof}
